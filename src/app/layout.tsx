  ...
  return (
    <html lang="en" className="dark scroll-smooth" suppressHydrationWarning>
      <body className={`${geistSans.variable} ${geistMono.variable} bg-[#020202] text-white antialiased min-h-screen selection:bg-purple-500 selection:text-white`}>
        ...
        {/* Global Floating WhatsApp Icon Only (No Text) */}
        <a
          href="https://wa.me/919842161122?text=Hello%20Nex%20ApX,%20I%20would%20like%20to%20enquire%20about%20your%20services."
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-110 hover:bg-[#20ba5a]"
